...
// Mock heavy dependencies before importing generateTilt (no JSX needed)
...
import { generateTilt } from '../TimelineScreen';

describe('Property 1: Tilt rotation is bounded', () => {
  it('generateTilt() always returns a value in [-3, 3]', () => {
    fc.assert(
      fc.property(fc.constant(null), () => {
        const tilt = generateTilt();
